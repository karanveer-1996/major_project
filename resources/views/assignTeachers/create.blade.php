...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Assign Teachers</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Assign Teachers</h6>
        </div>
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route('teacherAssign.store') }}">
                @csrf
